...
func (rcv *ChatMessage) Metadata(obj *ChatMetadata) *ChatMetadata {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
		x := rcv._tab.Indirect(o + rcv._tab.Pos)
		if obj == nil {
			obj = new(ChatMetadata)
		}
...
func (rcv *ChatMessage) Content() []byte {
...
func ChatMessageAddMetadata(builder *flatbuffers.Builder, metadata flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(metadata), 0)
}
func ChatMessageAddContent(builder *flatbuffers.Builder, content flatbuffers.UOffsetT) {
